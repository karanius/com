...
import { Verification } from "coral-server/models/verifications";
...
export interface MongoContext {
  ...
  verifications(): Collection<Readonly<Verification>>;
}
...
export class MongoContextImpl implements MongoContext {
  ...
  public verifications(): Collection<Readonly<Verification>> {
    return createCollection<Verification>("verifications")(this.live);
  }
