...
email-template-accountNotificationConfirmEmail =
  Hello,<br/><br/>
  To confirm your email address for use with your commenting account at { $organizationName },<br/><br/>
  Here is your verification code:  <div data-l10n-name="verificationCode">{ $verificationCode } </div><br/><br/>
