...
error-emailAlreadyExists= Email address already in use. please choose another.
...
error-duplicatePhone = Specified phone number is already in use.
...
error-notVerifiedError = Incorrect verification code!
...
error-incorrectVerificationCode= Incorrect verification code.
...
error-phoneAlreadyExists = The phone number is already exists. Please choose another.
