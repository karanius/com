...
export class DuplicatePhoneError extends CoralError {
  constructor(email: string) {
    super({ code: ERROR_CODES.DUPLICATE_PHONE, context: { pvt: { email } } });
  }
}
...
export class EmailAlreadyExists extends CoralError {
  constructor() {
    super({ code: ERROR_CODES.EMAIL_ALREADY_EXISTS });
  }
}
...
export class NotVerifiedError extends CoralError {
  constructor(reason: string) {
    super({
      code: ERROR_CODES.NOT_VERIFIED_ERROR,
      status: 401,
      context: { pvt: { reason } },
    });
  }
...
export class IncorrectVerificationCode extends CoralError {
  constructor(reason: string, cause?: Error) {
    super({
      code: ERROR_CODES.INCORRECT_VERIFICATION_CODE,
      cause,
      status: 400,
      context: { pvt: { reason } },
    });
...
export class PhoneAlreadyExistsError extends CoralError {
  constructor(tenantID: string, phone: string) {
    super({
      code: ERROR_CODES.PHONE_ALREADY_EXISTS,
      status: 400,
      context: { tenantID, pvt: { tenantID, phone } },
    });
  }
}
