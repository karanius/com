...
export const ERROR_TRANSLATIONS: Record<ERROR_CODES, string> = {
  ...
  DUPLICATE_PHONE: "error-duplicatePhone",
  ...
  NOT_VERIFIED_ERROR: "error-notVerifiedError",
  ...
  INCORRECT_VERIFICATION_CODE: "error-incorrectVerificationCode",
  ...
  PHONE_ALREADY_EXISTS: "error-phoneAlreadyExists",
};
