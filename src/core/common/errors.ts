...
export enum ERROR_CODES {
  ...
  /**
   * DUPLICATE_PHONE is returned when a user attempts to create an account
   * with the same PHONE address as another user.
   */
  ...
  /**
   * NOT_VERIFIED_ERROR is returned when user is not verified his email.
   */
