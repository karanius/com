...
configure-auth-secret-password-description = A secret password to manage user access from admin.
...
configure-auth-showCommentStreamRegistration = Show comment stream registration
...
configure-auth-secret-password-settings = Secret password
